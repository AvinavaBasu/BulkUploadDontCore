...
namespace BulkUploadDontCore
{
    class Program
    {
        private static readonly string EndpointUrl = "https://raetgdprhasdev.documents.azure.com:443/";
        private static readonly string AuthorizationKey = "s43ywXCWDuHSXEGbND0G097bqN4UeZcjiISwhTzkfJ0I86GxmMT1uso4yWSHGKMavJyNjacidIrLXATaObO4zw ==";
        private static readonly string DatabaseName = "EAEventStore";
        private static readonly string CollectionName = "EAEvents";
        private static readonly int CollectionThroughput = 10000;
